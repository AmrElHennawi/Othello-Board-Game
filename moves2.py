...
class Board:
                ...
                if self.board[i][j] == current_color:
                    for right in range(j+1, self.boardSize - 1):
                        ...
                        if self.board[i][right] == -current_color and self.board[i][right+1] == 0:
                            self.sandwichCells.append(((i, j), (i, right+1)))
                    ...
                    for left in range(j-1, 0, -1):
                        ...
                        if self.board[i][left] == -current_color and self.board[i][left-1] == 0:
                            self.sandwichCells.append(((i, j), (i, left-1)))
                    ...
                    for down in range(i+1, self.boardSize - 1):
                        ...
                        if self.board[down][j] == -current_color and self.board[down+1][j] == 0:
                            self.sandwichCells.append(((i, j), (down+1, j)))
                    ...
                    for up in range(i-1, 0, -1):
                        ...
                        if self.board[up][j] == -current_color and self.board[up-1][j] == 0:
                            self.sandwichCells.append(((i, j), (up-1, j)))
    ...
    def colorInBetween(self, i, j, current_color):
        for cell in self.sandwichCells:
            if cell[0] == (i, j):
                if i == cell[1][0]:
                    for k in range(j+1, cell[1][1]):
                        self.board[i][k] = current_color
                elif j == cell[1][1]:
                    for k in range(i+1, cell[1][0]):
                        self.board[k][j] = current_color
                elif i == cell[1][0] and j == cell[1][1]:
                    for k in range(i+1, cell[1][0]):
                        self.board[k][k] = current_color
                elif i == cell[1][0] and j == cell[1][1]:
                    for k in range(i+1, cell[1][0]):
                        self.board[k][k] = current_color
        self.colorBoard()
